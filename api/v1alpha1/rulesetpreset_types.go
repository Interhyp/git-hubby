...
type RulesetPresetSpec struct {
	...
	// foo is an example field of RulesetPreset. Edit rulesetpreset_types.go to remove/update
	// +optional
...
func init() {
	SchemeBuilder.Register(func(s *runtime.Scheme) error {
		s.AddKnownTypes(SchemeGroupVersion, &RulesetPreset{}, &RulesetPresetList{})
		return nil
	})
}
